...
const VariantsleftUpImpl = ({ size = 24, color = "currentColor", ...props }: IconProps) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
...
const VariantsleftUp = memo(VariantsleftUpImpl);
VariantsleftUp.displayName = "VariantsleftUp";
export { VariantsleftUp };
