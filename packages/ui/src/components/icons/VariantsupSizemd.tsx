...
const VariantsupSizemdImpl = ({ size = 24, color = "currentColor", ...props }: IconProps) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
...
const VariantsupSizemd = memo(VariantsupSizemdImpl);
VariantsupSizemd.displayName = "VariantsupSizemd";
export { VariantsupSizemd };
