...
export interface Frame02Props extends HTMLAttributes<HTMLDivElement> {
  onClose?: () => void;
}

const Frame02Component = ({
  onClose,
  className = "",
  style,
  ...props
  ...
  return (
    <div className={`frame02 ${className}`} style={frameStyle} {...props}>
      <Screen variants="subW2">
        ...
        >
          ...
          <SelectChip variants="single" isExpand={false}>
            <SelectChipItem variants="single" state="enabled" isSelected={true} label="입출금" />
            <SelectChipItem variants="single" state="enabled" isSelected={false} label="예금" />
            <SelectChipItem variants="single" state="enabled" isSelected={false} label="적금" />
            <SelectChipItem variants="single" state="enabled" isSelected={false} label="대출" />
            <SelectChipItem variants="single" state="enabled" isSelected={false} label="외환" />
            <SelectChipItem variants="single" state="enabled" isSelected={false} label="환전" />
            <SelectChipItem variants="single" state="enabled" isSelected={false} label="라벨" />
            <SelectChipItem variants="single" state="enabled" isSelected={false} label="라벨" />
            <SelectChipItem variants="single" state="enabled" isSelected={false} label="라벨" />
            <SelectChipItem variants="single" state="enabled" isSelected={false} label="라벨" />
          </SelectChip>
          ...
          >
                ...
                >
                  ...
                  >
                    <span
                      ...
                      style={{ color: "var(--texticon-gray-subtle2)", margin: 0, whiteSpace: "nowrap" }}
                    >
                  ...
                  >
                    ...
                    <span
                      className="text-style-kbfgtext-label-16-bold"
                      style={{ color: "var(--texticon-system-info-subtle2)", margin: 0, whiteSpace: "nowrap" }}
                    >
                      연 2.5%
                    </span>
                  </div>
            ...
            />
            <Divider color="strong" weight="thin" direction="horizontal" />
            <ContentsListItem
              hasGutter={false}
              slotCenter={
                <div
...
const Frame02 = memo(Frame02Component);
Frame02.displayName = "Frame02";
export { Frame02 };